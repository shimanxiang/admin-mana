  ...
  <div class="product tableData">
    <div class="productList" v-show="compStatus == 0">
      ...
      <el-table border :data="productList">
            ...
            <el-form label-position="left" inline class="demo-table-expand">
              <el-form-item label="商品副图片：">
                <img
                  ...
                  alt=""
                  srcset=""
                  v-for="(item, index) in props.row.secondImg"
                  :key="index"
                />
              </el-form-item>
        ...
        <el-table-column label="商品主图片" width="100px">
          <template slot-scope="scope">
            <img :src="scope.row.mainImg" alt="" srcset="" />
          </template>
        </el-table-column>
        <el-table-column label="商品类别" prop="categoryName">
        </el-table-column>
        <el-table-column label="商品描述" prop="prodDesc"> </el-table-column>
        <el-table-column label="已售" prop="sellCount" width="80px">
        </el-table-column>
        ...
        <el-table-column label="操作" width="210px">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              @click="upperShelfProduct(scope.$index, scope.row.id)"
              >上架</el-button
            >
          </template>
        </el-table-column>
